...
public extension Date {
    ...
    */
    ...
    func dateFor(_ type:DateForType) -> Date {
        ...
        // Modified .startOfWeek to return Sunday of current week.
        // It was returning wrong date
        case .startOfWeek:
...
//            return dateWith(hour: 0, minute: 0, second: 0, day: firstDayOfWeek)
        case .endOfWeek:
          let lastDayOfWeek = self.firstDayOfWeek()+6
...
//             return dateWith(hour: 0, minute: 0, second: 0, day: lastDayOfWeek)
    ...
    func hourMin() -> String {
      return self.toString(format: .hourMin)
    }
...
public enum DateFormatType {
    ...
    /// Returns time in hh:mm ex. "08:45"
    case hourMin
